<?php if ( have_posts() ) : ?>
	...
	<div <?php post_class('post_list clear'); ?> id="post-<?php the_ID(); ?>">
		...
		<div class="post_list_meta">
			<p class="post_date"><?php printf(__('Posted on %s by %s'), get_the_time(__('F jS, Y')), get_the_author()); ?></p>
			...
			<div class="post_share">&mdash;<br /><a href="javascript: void(0);" class="sharethis"><?php _e('Share this post'); ?></a>
				<ul class="sharelist">
					...
					<li><a href="http://digg.com/submit?phase=2&amp;amp;url=<?php the_permalink() ?>&amp;amp;title=<?php echo urlencode(the_title('','', false)) ?>" target="_blank">Digg</a></li>
		...
		<div class="post_content">
			...
			<p class="more">&mdash; <a href="<?php the_permalink() ?>#more"><?php _e('Read more'); ?></a></p>
		</div>
	</div>
